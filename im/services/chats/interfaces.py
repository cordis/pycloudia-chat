...
class IService(object):
    ...
    def get_thread_messages(self, actor, thread, limit=None, offset=None):
        """
        :type actor: L{im.services.chats.interfaces.IActor}
        :type thread: L{im.services.chats.interfaces.IChatIdentity}
    ...
    def create_thread_message(self, actor, thread, content):
        ...
        :type actor: L{im.services.chats.interfaces.IActor}
        :type thread: L{im.services.chats.interfaces.IChatIdentity}
        :type content: L{im.services.chats.interfaces.IChatMessageContent}
        """
