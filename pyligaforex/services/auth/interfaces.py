...
class IServiceFactory(object):
    ...
    def create_service(self):
        """
        :rtype: L{pyligaforex.services.auth.interfaces.IService}
        """
...
class IService(object):
    ...
    def authenticate(self, client_id, platform, access_token):
        ...
        :raise: L{pyligaforex.services.auth.exceptions.AuthError}
        """
...
class IDao(object):
    ...
    def set_user_friends(self, user_id, platform, profile_list):
        ...
        :type user_id: C{str}
        :type platform: C{str}
        :type profile_list: C{list} of L{pyligaforex.services.auth.platforms.interfaces.IProfile}
...
class ISessionsFactory(object):
    ...
    def create_service(self):
        """
        :rtype: L{pyligaforex.services.auth.interfaces.ISessions}
        """
...
class IUsersFactory(object):
    ...
    def create_service(self):
        """
        :rtype: L{pyligaforex.services.auth.interfaces.IUsers}
        """
...
class IPlatforms(object):
    ...
    def get(self, platform):
        """
        :type platform: C{str}
        :rtype: L{pyligaforex.services.auth.platforms.interfaces.IAdapter}
        :raise: C{KeyError}
        """
