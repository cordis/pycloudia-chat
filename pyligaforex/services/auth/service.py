...
from pyligaforex.services.auth.interfaces import IService, IServiceFactory


class Service(IService):
    """
    :type reactor: L{pycloudia.reactor.interfaces.IIsolatedReactor}
    :type dao: L{pyligaforex.services.auth.interfaces.IDao}
    :type users: L{pyligaforex.services.auth.interfaces.IUsers}
    :type sessions: L{pyligaforex.services.auth.interfaces.ISessions}
    :type platforms: L{pyligaforex.services.auth.interfaces.IPlatforms}
    """
    reactor = None
    dao = None
    users = None
