...
from pyligaforex.services.gateways.consts import DEFAULT
from pyligaforex.services.gateways.interfaces import IGateway, IGatewayFactory


class Gateway(IGateway):
    """
    :type router: L{pyligaforex.services.gateways.interfaces.IRouter}
